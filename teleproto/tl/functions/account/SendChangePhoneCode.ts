...
export class SendChangePhoneCode extends MTProtoRequest {
    static CONSTRUCTOR_ID = 2186758885;
    static SUBCLASS_OF_ID = 1827172481;
    static className = "account.SendChangePhoneCode";
    static classType = "request";

    phoneNumber?: string;
    settings!: TypeCodeSettings;

    constructor(args: { phoneNumber?: string, settings?: TypeCodeSettings } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(2186758885, false);
    ...
    static fromReader(reader: BinaryReader): SendChangePhoneCode {
        const args: any = {};
        ...
        return new SendChangePhoneCode(args);
    }
}