...
export class SendVerifyPhoneCode extends MTProtoRequest {
    static CONSTRUCTOR_ID = 2778945273;
    static SUBCLASS_OF_ID = 1827172481;
    static className = "account.SendVerifyPhoneCode";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(2778945273, false);
    ...
    static fromReader(reader: BinaryReader): SendVerifyPhoneCode {
        const args: any = {};
        ...
        return new SendVerifyPhoneCode(args);
    }
}