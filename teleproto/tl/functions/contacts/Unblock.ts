...
export class Unblock extends MTProtoRequest {
    static CONSTRUCTOR_ID = 3041973032;
    static SUBCLASS_OF_ID = 4122188204;
    static className = "contacts.Unblock";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(3041973032, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): Unblock {
        const args: any = {};
