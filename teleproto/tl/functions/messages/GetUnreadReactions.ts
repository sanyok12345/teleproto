...
export class GetUnreadReactions extends MTProtoRequest {
    static CONSTRUCTOR_ID = 3179253932;
    static SUBCLASS_OF_ID = 3568569182;
    static className = "messages.GetUnreadReactions";
    ...
    constructor(args: { flags?: number, peer?: EntityLike, topMsgId?: number, savedPeerId?: EntityLike, offsetId?: number, addOffset?: number, limit?: number, maxId?: number, minId?: number } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(3179253932, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): GetUnreadReactions {
        const args: any = {};
        ...
        args.minId = _minId;
        return new GetUnreadReactions(args);
    }
}