...
export class SendMedia extends MTProtoRequest {
    static CONSTRUCTOR_ID = 53536639;
    static SUBCLASS_OF_ID = 2331323052;
    static className = "messages.SendMedia";
    ...
    constructor(args: { flags?: number, silent?: boolean, background?: boolean, clearDraft?: boolean, noforwards?: boolean, updateStickersetsOrder?: boolean, invertMedia?: boolean, allowPaidFloodskip?: boolean, peer?: EntityLike, replyTo?: TypeInputReplyTo, media?: TypeInputMedia, message?: string, randomId?: bigint, replyMarkup?: TypeReplyMarkup, entities?: TypeMessageEntity[], scheduleDate?: number, scheduleRepeatPeriod?: number, sendAs?: EntityLike, quickReplyShortcut?: TypeInputQuickReplyShortcut, effect?: bigint, allowPaidStars?: bigint, suggestedPost?: TypeSuggestedPost } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(53536639, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): SendMedia {
        const args: any = {};
