...
export class UnpinAllMessages extends MTProtoRequest {
    static CONSTRUCTOR_ID = 103667527;
    static SUBCLASS_OF_ID = 743031062;
    static className = "messages.UnpinAllMessages";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(103667527, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): UnpinAllMessages {
        const args: any = {};
        ...
        return new UnpinAllMessages(args);
    }
}