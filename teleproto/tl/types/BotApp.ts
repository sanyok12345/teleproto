...
export class BotApp extends TLObject {
    static CONSTRUCTOR_ID = 2516373974;
    static SUBCLASS_OF_ID = 34550446;
    static className = "BotApp";
    ...
    constructor(args: { flags?: number, id?: bigint, accessHash?: bigint, shortName?: string, title?: string, description?: string, photo?: TypePhoto, document?: TypeDocument, hash?: bigint } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(2516373974, false);
        let flags = 0;
