...
export class BotInlineMessageText extends TLObject {
    static CONSTRUCTOR_ID = 2357159394;
    static SUBCLASS_OF_ID = 3297841032;
    static className = "BotInlineMessageText";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(2357159394, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): BotInlineMessageText {
        const args: any = {};
        ...
        return new BotInlineMessageText(args);
    }
}