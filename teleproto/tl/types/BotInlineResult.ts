...
export class BotInlineResult extends TLObject {
    static CONSTRUCTOR_ID = 295067450;
    static SUBCLASS_OF_ID = 942846933;
    static className = "BotInlineResult";
    ...
    constructor(args: { flags?: number, id?: string, type?: string, title?: string, description?: string, url?: string, thumb?: TypeWebDocument, content?: TypeWebDocument, sendMessage?: TypeBotInlineMessage } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(295067450, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): BotInlineResult {
        const args: any = {};
        ...
        return new BotInlineResult(args);
    }
}