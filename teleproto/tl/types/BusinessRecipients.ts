...
export class BusinessRecipients extends TLObject {
    static CONSTRUCTOR_ID = 554733559;
    static SUBCLASS_OF_ID = 1384459846;
    static className = "BusinessRecipients";
    ...
    constructor(args: { flags?: number, existingChats?: boolean, newChats?: boolean, contacts?: boolean, nonContacts?: boolean, excludeSelected?: boolean, users?: bigint[] } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(554733559, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): BusinessRecipients {
        const args: any = {};
        ...
        return new BusinessRecipients(args);
    }
}