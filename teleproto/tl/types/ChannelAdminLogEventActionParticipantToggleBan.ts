...
export class ChannelAdminLogEventActionParticipantToggleBan extends TLObject {
    static CONSTRUCTOR_ID = 3872931198;
    static SUBCLASS_OF_ID = 2998503411;
    static className = "ChannelAdminLogEventActionParticipantToggleBan";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(3872931198, false);
        writer.write(this.prevParticipant.getBytes());
        writer.write(this.newParticipant.getBytes());
        return writer.getValue();
    }

    static fromReader(reader: BinaryReader): ChannelAdminLogEventActionParticipantToggleBan {
        const args: any = {};
        ...
        return new ChannelAdminLogEventActionParticipantToggleBan(args);
    }
}