...
export class InputBotAppID extends TLObject {
    static CONSTRUCTOR_ID = 2837495162;
    static SUBCLASS_OF_ID = 3059063121;
    static className = "InputBotAppID";
