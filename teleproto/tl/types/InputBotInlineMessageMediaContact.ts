...
export class InputBotInlineMessageMediaContact extends TLObject {
    static CONSTRUCTOR_ID = 2800599037;
    static SUBCLASS_OF_ID = 1408974864;
    static className = "InputBotInlineMessageMediaContact";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(2800599037, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): InputBotInlineMessageMediaContact {
        const args: any = {};
        ...
        return new InputBotInlineMessageMediaContact(args);
    }
}