...
export class InputChannelFromMessage extends TLObject {
    static CONSTRUCTOR_ID = 1536380829;
    static SUBCLASS_OF_ID = 1089602301;
    static className = "InputChannelFromMessage";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(1536380829, false);
    ...
    static fromReader(reader: BinaryReader): InputChannelFromMessage {
        const args: any = {};
        ...
        return new InputChannelFromMessage(args);
    }
}