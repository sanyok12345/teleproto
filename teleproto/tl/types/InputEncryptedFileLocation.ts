...
export class InputEncryptedFileLocation extends TLObject {
    static CONSTRUCTOR_ID = 4112735573;
    static SUBCLASS_OF_ID = 354669666;
    static className = "InputEncryptedFileLocation";
