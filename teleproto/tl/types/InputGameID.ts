...
export class InputGameID extends TLObject {
    static CONSTRUCTOR_ID = 53231223;
    static SUBCLASS_OF_ID = 1221679235;
    static className = "InputGameID";
