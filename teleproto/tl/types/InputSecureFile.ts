...
export class InputSecureFile extends TLObject {
    static CONSTRUCTOR_ID = 1399317950;
    static SUBCLASS_OF_ID = 3670584828;
    static className = "InputSecureFile";
