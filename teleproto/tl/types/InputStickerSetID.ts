...
export class InputStickerSetID extends TLObject {
    static CONSTRUCTOR_ID = 2649203305;
    static SUBCLASS_OF_ID = 1034127786;
    static className = "InputStickerSetID";
