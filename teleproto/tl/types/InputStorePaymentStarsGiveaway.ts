...
export class InputStorePaymentStarsGiveaway extends TLObject {
    static CONSTRUCTOR_ID = 1964968186;
    static SUBCLASS_OF_ID = 3886290765;
    static className = "InputStorePaymentStarsGiveaway";
    ...
    constructor(args: { flags?: number, onlyNewSubscribers?: boolean, winnersAreVisible?: boolean, stars?: bigint, boostPeer?: TypeInputPeer, additionalPeers?: TypeInputPeer[], countriesIso2?: string[], prizeDescription?: string, randomId?: bigint, untilDate?: number, currency?: string, amount?: bigint, users?: number } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(1964968186, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): InputStorePaymentStarsGiveaway {
        const args: any = {};
        ...
        args.users = _users;
        return new InputStorePaymentStarsGiveaway(args);
    }
}