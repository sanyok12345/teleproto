...
export class PQInnerDataDc extends TLObject {
    static CONSTRUCTOR_ID = 2851430293;
    static SUBCLASS_OF_ID = 1097864055;
    static className = "PQInnerDataDc";
    ...
    constructor(args: { pq?: Buffer, p?: Buffer, q?: Buffer, nonce?: bigint, serverNonce?: bigint, newNonce?: bigint, dc?: number } = {}) {
        super();
        this.pq = args.pq!;
        this.p = args.p!;
        this.q = args.q!;
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(2851430293, false);
    ...
    static fromReader(reader: BinaryReader): PQInnerDataDc {
        const args: any = {};
