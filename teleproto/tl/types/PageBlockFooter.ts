...
export class PageBlockFooter extends TLObject {
    static CONSTRUCTOR_ID = 1216809369;
    static SUBCLASS_OF_ID = 449467972;
    static className = "PageBlockFooter";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(1216809369, false);
        writer.write(this.text.getBytes());
        return writer.getValue();
    }

    static fromReader(reader: BinaryReader): PageBlockFooter {
        const args: any = {};
        const _text = reader.tgReadObject();
        args.text = _text;
        return new PageBlockFooter(args);
    }
}