...
export class PhoneCallAccepted extends TLObject {
    static CONSTRUCTOR_ID = 912311057;
    static SUBCLASS_OF_ID = 3296664529;
    static className = "PhoneCallAccepted";
    ...
    constructor(args: { flags?: number, video?: boolean, id?: bigint, accessHash?: bigint, date?: number, adminId?: bigint, participantId?: bigint, gB?: Buffer, protocol?: TypePhoneCallProtocol } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(912311057, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): PhoneCallAccepted {
        const args: any = {};
        ...
        return new PhoneCallAccepted(args);
    }
}