...
export class SecureValue extends TLObject {
    ...
    constructor(args: { flags?: number, type?: TypeSecureValueType, data?: TypeSecureData, frontSide?: TypeSecureFile, reverseSide?: TypeSecureFile, selfie?: TypeSecureFile, translation?: TypeSecureFile[], files?: TypeSecureFile[], plainData?: TypeSecurePlainData, hash?: Buffer } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(411017418, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): SecureValue {
        const args: any = {};
