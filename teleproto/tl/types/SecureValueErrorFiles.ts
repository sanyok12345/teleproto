...
export class SecureValueErrorFiles extends TLObject {
    static CONSTRUCTOR_ID = 1717706985;
    static SUBCLASS_OF_ID = 101146574;
    static className = "SecureValueErrorFiles";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(1717706985, false);
    ...
    static fromReader(reader: BinaryReader): SecureValueErrorFiles {
        const args: any = {};
        ...
        args.text = _text;
        return new SecureValueErrorFiles(args);
    }
}