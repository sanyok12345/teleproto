...
export class SecureValueErrorReverseSide extends TLObject {
    static CONSTRUCTOR_ID = 2257201829;
    static SUBCLASS_OF_ID = 101146574;
    static className = "SecureValueErrorReverseSide";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(2257201829, false);
    ...
    static fromReader(reader: BinaryReader): SecureValueErrorReverseSide {
        const args: any = {};
        ...
        args.text = _text;
        return new SecureValueErrorReverseSide(args);
    }
}