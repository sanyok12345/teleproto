...
export class StarGiftAttributeModel extends TLObject {
    static CONSTRUCTOR_ID = 970559507;
    static SUBCLASS_OF_ID = 2276819400;
    static className = "StarGiftAttributeModel";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(970559507, false);
    ...
    static fromReader(reader: BinaryReader): StarGiftAttributeModel {
        const args: any = {};
        ...
        return new StarGiftAttributeModel(args);
    }
}