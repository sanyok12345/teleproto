...
export class StarsTopupOption extends TLObject {
    static CONSTRUCTOR_ID = 198776256;
    static SUBCLASS_OF_ID = 3854345708;
    static className = "StarsTopupOption";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(198776256, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): StarsTopupOption {
        const args: any = {};
        ...
        args.amount = _amount;
        return new StarsTopupOption(args);
    }
}