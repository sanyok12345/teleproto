...
export class TextMarked extends TLObject {
    static CONSTRUCTOR_ID = 55281185;
    static SUBCLASS_OF_ID = 4056986745;
    static className = "TextMarked";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(55281185, false);
        writer.write(this.text.getBytes());
        return writer.getValue();
    }

    static fromReader(reader: BinaryReader): TextMarked {
        const args: any = {};
        const _text = reader.tgReadObject();
        args.text = _text;
        return new TextMarked(args);
    }
}