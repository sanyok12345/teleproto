...
export class TextSuperscript extends TLObject {
    static CONSTRUCTOR_ID = 3355139585;
    static SUBCLASS_OF_ID = 4056986745;
    static className = "TextSuperscript";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(3355139585, false);
        writer.write(this.text.getBytes());
        return writer.getValue();
    }

    static fromReader(reader: BinaryReader): TextSuperscript {
        const args: any = {};
        const _text = reader.tgReadObject();
        args.text = _text;
        return new TextSuperscript(args);
    }
}