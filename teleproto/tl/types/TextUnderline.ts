...
export class TextUnderline extends TLObject {
    static CONSTRUCTOR_ID = 3240501956;
    static SUBCLASS_OF_ID = 4056986745;
    static className = "TextUnderline";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(3240501956, false);
        writer.write(this.text.getBytes());
        return writer.getValue();
    }

    static fromReader(reader: BinaryReader): TextUnderline {
        const args: any = {};
        const _text = reader.tgReadObject();
        args.text = _text;
        return new TextUnderline(args);
    }
}