...
export class UpdateBotNewBusinessMessage extends TLObject {
    static CONSTRUCTOR_ID = 2648388732;
    static SUBCLASS_OF_ID = 2676568142;
    static className = "UpdateBotNewBusinessMessage";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(2648388732, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): UpdateBotNewBusinessMessage {
        const args: any = {};
        ...
        args.qts = _qts;
        return new UpdateBotNewBusinessMessage(args);
    }
}