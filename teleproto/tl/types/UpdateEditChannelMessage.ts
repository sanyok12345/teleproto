...
export class UpdateEditChannelMessage extends TLObject {
    static CONSTRUCTOR_ID = 457133559;
    static SUBCLASS_OF_ID = 2676568142;
    static className = "UpdateEditChannelMessage";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(457133559, false);
    ...
    static fromReader(reader: BinaryReader): UpdateEditChannelMessage {
        const args: any = {};
        ...
        return new UpdateEditChannelMessage(args);
    }
}