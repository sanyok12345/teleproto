...
export class UpdateInlineBotCallbackQuery extends TLObject {
    static CONSTRUCTOR_ID = 1763610706;
    static SUBCLASS_OF_ID = 2676568142;
    static className = "UpdateInlineBotCallbackQuery";
    ...
    constructor(args: { flags?: number, queryId?: bigint, userId?: bigint, msgId?: MessageIDLike, chatInstance?: bigint, data?: Buffer, gameShortName?: string } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(1763610706, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): UpdateInlineBotCallbackQuery {
        const args: any = {};
        ...
        return new UpdateInlineBotCallbackQuery(args);
    }
}