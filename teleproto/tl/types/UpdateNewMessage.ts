...
export class UpdateNewMessage extends TLObject {
    static CONSTRUCTOR_ID = 522914557;
    static SUBCLASS_OF_ID = 2676568142;
    static className = "UpdateNewMessage";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(522914557, false);
    ...
    static fromReader(reader: BinaryReader): UpdateNewMessage {
        const args: any = {};
        ...
        return new UpdateNewMessage(args);
    }
}