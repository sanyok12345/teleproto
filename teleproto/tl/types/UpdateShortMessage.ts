...
export class UpdateShortMessage extends TLObject {
    static CONSTRUCTOR_ID = 826001400;
    static SUBCLASS_OF_ID = 2331323052;
    static className = "UpdateShortMessage";
    ...
    constructor(args: { flags?: number, out?: boolean, mentioned?: boolean, mediaUnread?: boolean, silent?: boolean, id?: number, userId?: bigint, message?: string, pts?: number, ptsCount?: number, date?: number, fwdFrom?: TypeMessageFwdHeader, viaBotId?: bigint, replyTo?: TypeMessageReplyHeader, entities?: TypeMessageEntity[], ttlPeriod?: number } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(826001400, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): UpdateShortMessage {
        const args: any = {};
        ...
        return new UpdateShortMessage(args);
    }
}