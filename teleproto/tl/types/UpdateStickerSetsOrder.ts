...
export class UpdateStickerSetsOrder extends TLObject {
    static CONSTRUCTOR_ID = 196268545;
    static SUBCLASS_OF_ID = 2676568142;
    static className = "UpdateStickerSetsOrder";
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(196268545, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): UpdateStickerSetsOrder {
        const args: any = {};
        ...
        args.order = _order;
        return new UpdateStickerSetsOrder(args);
    }
}