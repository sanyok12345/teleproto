...
export class MessageReactionsList extends TLObject {
    static CONSTRUCTOR_ID = 834488621;
    static SUBCLASS_OF_ID = 1627186662;
    static className = "messages.MessageReactionsList";
    static classType = "constructor";

    flags!: number;
    count!: number;
    reactions!: TypeMessagePeerReaction[];
    chats!: TypeChat[];
    users!: TypeUser[];
    nextOffset?: string;

    constructor(args: { flags?: number, count?: number, reactions?: TypeMessagePeerReaction[], chats?: TypeChat[], users?: TypeUser[], nextOffset?: string } = {}) {
        super();
    ...
    getBytes(): Buffer {
        ...
        writer.writeInt(834488621, false);
        let flags = 0;
    ...
    static fromReader(reader: BinaryReader): MessageReactionsList {
        const args: any = {};
        ...
        return new MessageReactionsList(args);
    }
}